return {
    ...
    config = function ()
        ...
        vim.keymap.set('n', '<leader>gf', "<cmd>lua require('fzf-lua').git_files()<CR>", { silent = true })
        ...
        vim.keymap.set('v', '<leader>gv', "<cmd>lua require('fzf-lua').grep_visual()<CR>", { silent = true })
